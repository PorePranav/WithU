        ...
        <DrawerContent>
            ...
            <DrawerBody> 
                <VStack
                    ...
                    <LinkButton  onClose={onClose} url="/courses" title=" Browerse all Courses" />
                    <LinkButton  onClose={onClose} url="/request" title="Request" />
                    <LinkButton  onClose={onClose} url="/about" title="About" />
                    <LinkButton  onClose={onClose} url="/contact" title="Contact" />
                    <LinkButton  onClose={onClose} url="/fundraiser" title="Fundraiser" />
                    <LinkButton  onClose={onClose} url="/testimonials" title="Testimonial" />
                  ...
                  <HStack justifyContent={`space-evenly`} position={`absolute`}  bottom={`2rem`}  width={`80%`}>
                    ...
                    <RiLogoutBoxLine/>
                        ...
                        <Button  colorScheme={`yellow`}  onClick={ logoutHandler } >LogOut </Button>
