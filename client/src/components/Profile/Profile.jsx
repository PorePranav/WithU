import { Container, Heading , Stack ,VStack , Avatar, Button, HStack,Text ,Image ,Modal, ModalOverlay, ModalContent, ModalCloseButton, ModalBody , Input , ModalFooter, useDisclosure, ModalHeader} from '@chakra-ui/react'
...
const Profile = () => {
    const user ={
        ...
        playlist:[
            {
                course:"abcd",
                poster:'https://w0.peakpx.com/wallpaper/759/390/HD-wallpaper-itachi-uchiha-kakashi-madara-mangekyo-sharingan-minato-sharingan.jpg'
            }
        ],
  ...
  return <Container minH={`100vh`} maxW={`container.lg`} py="8">
        ...
        <VStack spacing={`4`} alignItems={['center','flex-start']} >
            ...
            { user.role!=='admin' &&( <HStack>
                ...
                {user.subscription.status === "active"?(
                    <Button color={`yellow.500`} variant={`unstyled`}> Cancel The Subscription</Button>
                ):(
                    <Link to="/subscribe">
    ...
    <Heading children={`Playlist`} size={`md`} my="8" />
    {
        ...
        <ChangePhotoBox changeImageSumbitHandler={changeImageHandler} isOpen={isOpen} onClose={onClose} />
